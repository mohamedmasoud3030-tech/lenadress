...
export const landingShowroomProfile: LandingShowroomProfile = {
  ...
  heroDescription:
    'تصفحي الفساتين والملحقات المعروضة، قارني خيارات الإيجار والبيع، ثم أرسلي طلب موعد التجربة مباشرة عبر واتساب.',
  aboutTitle: 'من نحن',
  aboutDescription:
  ...
  steps: [
    ...
    {
      title: 'احجزي موعدك',
      description: 'أرسلي طلب الموعد عبر واتساب، وسيؤكد لكِ المعرض الوقت وتوفر القطعة.',
    },
    {
      title: 'جربي وأكدي',
  ...
  faq: [
    {
      ...
      answer: 'نعرض القطع الجاهزة للطلب حاليًا، ويؤكد المعرض توفر القطعة لتاريخ مناسبتك عند مراجعة طلب الموعد.',
    },
    {
    ...
    },
    {
      ...
      answer: 'نعم، تظهر الإكسسوارات والحقائب والأحذية والطرح المتاحة ضمن المعروض كلما توفرت.',
    },
  ],
  contact: {
    phone: '+968 9191 8186',
